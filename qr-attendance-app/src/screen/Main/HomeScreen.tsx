...
const HomeScreen = () => {
  ...
  const handleSearch = async () => {
    try {
      ...
      const updateResponse = await fetch(`http://192.168.1.19:3000/api/estudiantes/${id}`, options);
    ...
    try {
      const response = await fetch(`http://192.168.1.19:3000/api/estudiantes/${id}`);
